...
class MobileFaceNet(Module):
    def __init__(self):
        ...
        self.conv1 = ConvBlock(3, 32, kernel=(3, 3), stride=(2, 2), padding=(1, 1))
        ...
        self.conv_3 = Residual(32, num_block=2, groups=64, kernel=(3, 3), stride=(1, 1), padding=(1, 1))
        self.conv_34 = DepthWise(32, 64, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=128)
        self.conv_4 = Residual(64, num_block=2, groups=128, kernel=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        self.conv_6_sep = ConvBlock(64, 128, kernel=(1, 1), stride=(1, 1), padding=(0, 0))
        self.conv_6_dw = LinearBlock(128, 128, groups=128, kernel=(7, 7), stride=(1, 1), padding=(0, 0))
        self.flatten = Flatten()
        self.linear = Linear(128, 128, bias=False)
